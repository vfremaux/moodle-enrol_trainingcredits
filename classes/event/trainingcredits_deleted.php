 ...
 * }
 */
class trainingcredits_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_trainingcredits_deleted', 'enrol_trainingcredits');
    }
    ...
    public function get_description() {
        return "The training credits enrol '$this->objectid' has been created for course {$this->other->courseid}. ";
    }
