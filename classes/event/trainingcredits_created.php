...
/**
 * Event fired when a trainingcredits is created.
 *
 ...
 * }
 */
class trainingcredits_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_trainingcredits_created', 'enrol_trainingcredits');
    }
    ...
    public function get_description() {
        return "The programmmed trainingcredits enrol '$this->objectid' has been created for course {$this->other->courseid}. ";
    }
