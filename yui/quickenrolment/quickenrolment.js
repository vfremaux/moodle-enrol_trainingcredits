YUI.add('moodle-enrol_trainingcredits-quickenrolment', function(Y) {
    ...
    Y.extend(USERENROLLER, Y.Base, {
        ...
        initializer : function(config) {
                ...
                .append(create('<div class="'+CSS.WRAP+'"></div>')
                    ...
                    .append(create('<div class="'+CSS.CONTENT+'"></div>')
                        .append(create('<div class="'+CSS.SEARCHCONTROLS+'"></div>')
                            .append(create('<div class="'+CSS.ENROLMENTOPTION+' '+CSS.ROLE+'"><label for="id_enrol_trainingcredits_assignable_roles">'+M.str.role.assignroles+'</label></div>')
                                    .append(create('<select id="id_enrol_trainingcredits_assignable_roles"><option value="">'+M.str.enrol.none+'</option></select>'))
                            )
            ...
            Y.all('.enrol_trainingcredits_plugin input').each(function(node){
        ...
        populateAssignableRoles : function() {
            this.on('assignablerolesloaded', function(){
                ...
                Y.one('#id_enrol_trainingcredits_assignable_roles').focus();
            }, this);
        ...
        show : function(e) {
            ...
            var rolesselect = Y.one('#id_enrol_trainingcredits_assignable_roles');
            if (rolesselect) {
                rolesselect.focus();
            }
        },
    ...
    M.enrol_trainingcredits = M.enrol_trainingcredits || {};
    M.enrol_trainingcredits.quickenrolment = {
        init : function(cfg) {
